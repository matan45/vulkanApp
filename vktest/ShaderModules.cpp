...
void ShaderModules::createRenderPass(VkPhysicalDevice physicalDevice,VkDevice device, VkFormat swapChainImageFormat, DepthBuffering& d)
{
    ...
    depthAttachment.format = d.findDepthFormat(physicalDevice);
...
void ShaderModules::createGraphicsPipline(VkDevice device, const VkExtent2D& swapChainExtent, Discriptor& discriptor)
{
    ...
    pipelineLayoutInfo.pSetLayouts = &discriptor.descriptorSetLayout;
